...
class MyResolution extends React.Component {
    ...
    createResolution =  (resolution) => {
        return <Resolution refreshComponent={this.props.refreshComponent} username={this.props.username} showButton={false} resolution={resolution} key={resolution}/>;
    }
        ...
        return (
            <div class="columns mt-1 is-mobile is-centered">
                <div class="box has-text-centered is-one-third">
                    <h1 class="title has-text-white">My resolution</h1>
